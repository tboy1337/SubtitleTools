...
FILE_DESCRIPTION = "SubtitleTools - Complete subtitle workflow tool"
LEGAL_COPYRIGHT = (
  ...
  kids=[
    StringFileInfo([
      StringTable(
        ...
        StringStruct(u'InternalName', u'SubtitleTools'),
        StringStruct(u'LegalCopyright', u'{LEGAL_COPYRIGHT}'),
        StringStruct(u'OriginalFilename', u'SubtitleTools.exe'),
        StringStruct(u'ProductName', u'SubtitleTools'),
