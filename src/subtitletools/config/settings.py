...
SUPPORTED_AUDIO_EXTENSIONS = ["wav", "mp3", "aac", "flac", "ogg", "m4a", "wma"]

SUPPORTED_SUBTITLE_FORMATS = ["srt", "vtt", "ass", "ssa", "sub", "sbv", "ttml"]

# Translation service configurations
SUPPORTED_TRANSLATION_SERVICES = ["google", "google_cloud"]
...
def get_config(
    key: str, default: Optional[Union[str, int, float, bool]] = None
...
def get_all_config() -> Dict[str, Union[str, int, float, bool]]:
