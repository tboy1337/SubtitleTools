...
def generate_processing_description(
    ...
    *,  # Force keyword-only arguments
    ...
    fix_punctuation_enabled: bool = False,
    ocr_fix: bool = False,
    ...
    Args:
        ...
        fix_punctuation_enabled: Fix punctuation issues
...
def convert_subtitle_format(
    ...
    """
    return native_convert_format(subtitle_file, output_format)
