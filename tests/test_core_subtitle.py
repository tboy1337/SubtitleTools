...
class TestSubtitleProcessor:
    ...
    def test_parse_file_valid_srt(
        self, temp_dir: Path, sample_srt_content: str
    ) -> None:
    ...
    def test_save_file_custom_encoding(
        self, temp_dir: Path, sample_subtitles: list[srt.Subtitle]
    ) -> None:
    ...
    def test_save_file_directory_creation(
        self, temp_dir: Path, sample_subtitles: list[srt.Subtitle]
    ) -> None:
    ...
    def test_split_sentences(self) -> None:
        ...
        test_subtitles = [
            ...
            srt.Subtitle(
                2, timedelta(seconds=4), timedelta(seconds=6), "Third question?"
            ),
        ]
    ...
    def test_reconstruct_subtitles_basic(self) -> None:
        ...
        original_subtitles = [
            ...
            srt.Subtitle(
                2, timedelta(seconds=4), timedelta(seconds=6), "Test subtitle"
            ),
        ]
        translated_lines = ["Hola mundo", "Subtítulo de prueba"]

        result = self.processor.reconstruct_subtitles(
            original_subtitles, translated_lines, space=True, both=False
        )
    ...
    def test_filter_subtitles_min_duration(
    ...
    def test_filter_subtitles_max_duration(
        self, sample_subtitles: list[srt.Subtitle]
    ) -> None:
    ...
    def test_filter_subtitles_min_length(
        self, sample_subtitles: list[srt.Subtitle]
    ) -> None:
    ...
    def test_filter_subtitles_max_length(
        self, sample_subtitles: list[srt.Subtitle]
    ) -> None:
    ...
    def test_filter_subtitles_regex_pattern(
        self, sample_subtitles: list[srt.Subtitle]
    ) -> None:
        """Test filtering subtitles by regex pattern."""
        result = self.processor.filter_subtitles(
            sample_subtitles, regex_pattern=r"test|formatting"
        )
    ...
    def test_filter_subtitles_no_regex_match(
        self, sample_subtitles: list[srt.Subtitle]
    ) -> None:
        """Test filtering subtitles with regex that matches nothing."""
        result = self.processor.filter_subtitles(
            sample_subtitles, regex_pattern=r"nonexistent"
        )
    ...
    def test_adjust_timing_speed_factor(
        self, sample_subtitles: list[srt.Subtitle]
    ) -> None:
    ...
    def test_adjust_timing_combined(self, sample_subtitles: list[srt.Subtitle]) -> None:
        ...
        result = self.processor.adjust_timing(
            sample_subtitles, offset_seconds=2.0, speed_factor=0.5
        )
    ...
    def test_adjust_timing_negative_times_clamped(
        self, sample_subtitles: list[srt.Subtitle]
    ) -> None:
    ...
    def test_adjust_timing_zero_speed_factor(
        self, sample_subtitles: list[srt.Subtitle]
    ) -> None:
    ...
    def test_validate_subtitles_valid(
        self, sample_subtitles: list[srt.Subtitle]
    ) -> None:
    ...
    def test_validate_subtitles_invalid_timing(self) -> None:
        ...
        invalid_subtitles = [
            srt.Subtitle(
                1, timedelta(seconds=5), timedelta(seconds=3), "Invalid timing"
            )
        ]
...
class TestSubtitleProcessorEdgeCases:
    ...
    def test_reconstruct_subtitles_empty_lines(self) -> None:
        ...
        result = self.processor.reconstruct_subtitles(
            original_subtitles, translated_lines, both=False
        )
    ...
    def test_filter_subtitles_all_filtered(
        self, sample_subtitles: list[srt.Subtitle]
    ) -> None:
    ...
    def test_split_sentences_simple(self) -> None:
        ...
        subs = [
            ...
            srt.Subtitle(
                2, timedelta(seconds=4), timedelta(seconds=6), "I am fine. Thanks!"
            ),
        ]
    ...
    def test_split_sentences_chinese(self, mock_jieba_cut: Mock) -> None:
        ...
        mock_jieba_cut.return_value = [
            "你好",
            "世界",
            "很好",
        ]  # Only meaningful segments
    ...
    def test_split_sentences_chinese_fallback(self, mock_jieba_cut: Mock) -> None:
        ...
        subs = [
            srt.Subtitle(
                1, timedelta(seconds=1), timedelta(seconds=3), "你好世界. 我很好!"
            )
        ]
    ...
    def test_merge_subtitles_different_lengths(self) -> None:
        ...
        subs2 = [srt.Subtitle(1, timedelta(seconds=1), timedelta(seconds=3), "Hola")]
    ...
    def test_merge_subtitles_second_longer(self) -> None:
        ...
        subs1 = [srt.Subtitle(1, timedelta(seconds=1), timedelta(seconds=3), "Hello")]
        subs2 = [
            srt.Subtitle(1, timedelta(seconds=1), timedelta(seconds=3), "Hola"),
            srt.Subtitle(2, timedelta(seconds=4), timedelta(seconds=6), "Mundo"),
        ]
    ...
    def test_validate_subtitles_index_mismatch(self) -> None:
        ...
        subs = [
            srt.Subtitle(
                5, timedelta(seconds=1), timedelta(seconds=3), "Hello"
            )  # Wrong index
        ]
    ...
    def test_validate_subtitles_invalid_timing(self) -> None:
        ...
        subs = [
            srt.Subtitle(
                1, timedelta(seconds=5), timedelta(seconds=3), "Hello"
            )  # start > end
        ]
        issues = self.processor.validate_subtitles(subs)
    ...
    def test_validate_subtitles_overlap(self) -> None:
        ...
        subs = [
            ...
            srt.Subtitle(
                2, timedelta(seconds=3), timedelta(seconds=6), "World"
            ),  # Overlaps
        ]
        issues = self.processor.validate_subtitles(subs)
    ...
    def test_validate_subtitles_whitespace_content(self) -> None:
        ...
        subs = [
            srt.Subtitle(
                1, timedelta(seconds=1), timedelta(seconds=3), "   "
            )  # Empty content
        ]
        issues = self.processor.validate_subtitles(subs)
    ...
    def test_reconstruct_subtitles(self) -> None:
        ...
        result = self.processor.reconstruct_subtitles(
            original_subtitles, translated_lines, space=True, both=True
        )
    ...
    def test_reconstruct_subtitles_no_space(self) -> None:
        ...
        result = self.processor.reconstruct_subtitles(
            original_subtitles, translated_lines, space=False, both=False
        )
    ...
    def test_validate_subtitles_timing_issues(self) -> None:
        ...
        subtitles = [
            ...
            srt.Subtitle(
                index=2,
                start=timedelta(
                    seconds=0, microseconds=500000
                ),  # Overlaps with previous (after adjustment)
...
class TestSubtitleProcessorMissingCoverage:
    ...
    def test_split_sentences_chinese_jieba_exception(self) -> None:
        ...
        with patch("subtitletools.core.subtitle.JIEBA_AVAILABLE", True):
            with patch("jieba.cut", side_effect=Exception("Jieba error")):
                ...
                assert any(
                    "你好" in sentence or "世界" in sentence for sentence in result
                )
    ...
    def test_validate_subtitles_comprehensive(self) -> None:
        ...
        subtitles = [
            # Valid subtitle
            srt.Subtitle(
                1, timedelta(seconds=0), timedelta(seconds=2), "Valid subtitle"
            ),
            # Index mismatch
            srt.Subtitle(5, timedelta(seconds=3), timedelta(seconds=5), "Wrong index"),
            # Invalid timing (start >= end)
            srt.Subtitle(
                3, timedelta(seconds=8), timedelta(seconds=6), "Invalid timing"
            ),
