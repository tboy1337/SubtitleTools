...
class TestFindFFmpeg:
    ...
    def test_find_ffmpeg_not_in_path_but_in_common_location(self, mock_isfile: Mock, mock_run: Mock) -> None:
    ...
    @patch('subprocess.run')
    @patch('os.path.isfile')
    def test_find_ffmpeg_file_check_exception(self, mock_isfile: Mock, mock_run: Mock) -> None:
...
class TestExtractAudio:
    ...
    @patch('subtitletools.utils.audio.find_ffmpeg')
    @patch('subprocess.run')
    def test_extract_audio_success(self, mock_run: Mock, mock_find_ffmpeg: Mock) -> None:
    ...
    @patch('subtitletools.utils.audio.find_ffmpeg')
    @patch('subprocess.run')
    def test_extract_audio_temp_output(self, mock_run: Mock, mock_find_ffmpeg: Mock) -> None:
    ...
    @patch('subtitletools.utils.audio.find_ffmpeg')
    @patch('subprocess.run')
    def test_extract_audio_ffmpeg_failure(self, mock_run: Mock, mock_find_ffmpeg: Mock) -> None:
    ...
    @patch('subtitletools.utils.audio.find_ffmpeg')
    @patch('subprocess.run')
    def test_extract_audio_timeout(self, mock_run: Mock, mock_find_ffmpeg: Mock) -> None:
    ...
    @patch('subtitletools.utils.audio.find_ffmpeg')
    @patch('subprocess.run')
    def test_extract_audio_output_not_created(self, mock_run: Mock, mock_find_ffmpeg: Mock) -> None:
    ...
    @patch('subtitletools.utils.audio.find_ffmpeg')
    @patch('subprocess.run')
    def test_extract_audio_small_output_warning(self, mock_run: Mock, mock_find_ffmpeg: Mock) -> None:
...
class TestCleanupTempDir:
    ...
    @patch('os.path.exists')
    @patch('shutil.rmtree')
    def test_cleanup_temp_dir_success(self, mock_rmtree: Mock, mock_exists: Mock) -> None:
    ...
    @patch('os.path.exists')
    @patch('shutil.rmtree')
    def test_cleanup_temp_dir_exception(self, mock_rmtree: Mock, mock_exists: Mock) -> None:
...
class TestGetAudioDuration:
    ...
    def test_get_audio_duration_ffprobe_not_found(self, mock_find_ffprobe: Mock) -> None:
    ...
    @patch('subtitletools.utils.audio.find_ffprobe')
    @patch('subprocess.run')
    def test_get_audio_duration_success(self, mock_run: Mock, mock_find_ffprobe: Mock) -> None:
        ...
        mock_run.assert_called_once_with(
            ["/usr/bin/ffprobe", "-v", "quiet", "-print_format", "json", "-show_format", "test.wav"],
            stdout=subprocess.PIPE,
            stderr=subprocess.PIPE,
            text=True,
            timeout=30,
    ...
    @patch('subtitletools.utils.audio.find_ffprobe')
    @patch('subprocess.run')
    def test_get_audio_duration_ffprobe_failure(self, mock_run: Mock, mock_find_ffprobe: Mock) -> None:
    ...
    @patch('subtitletools.utils.audio.find_ffprobe')
    @patch('subprocess.run')
    def test_get_audio_duration_invalid_json(self, mock_run: Mock, mock_find_ffprobe: Mock) -> None:
    ...
    @patch('subtitletools.utils.audio.find_ffprobe')
    @patch('subprocess.run')
    def test_get_audio_duration_exception(self, mock_run: Mock, mock_find_ffprobe: Mock) -> None:
...
class TestFindFFprobe:
    ...
    @patch('subprocess.run')
    @patch('os.path.isfile')
    def test_find_ffprobe_not_in_path_but_in_common_location(self, mock_isfile: Mock, mock_run: Mock) -> None:
    ...
    @patch('subprocess.run')
    @patch('os.path.isfile')
    def test_find_ffprobe_file_check_exception(self, mock_isfile: Mock, mock_run: Mock) -> None:
        """Test exception during file existence check."""
        # PATH search fails
        mock_result = Mock()
        mock_result.returncode = 1
...
class TestThreadSafety:
    ...
    @patch('subtitletools.utils.audio.find_ffmpeg')
    @patch('subprocess.run')
    def test_temp_dir_thread_safety(self, mock_run: Mock, mock_find_ffmpeg: Mock, mock_mkdtemp: Mock) -> None:
        ...
        assert mock_mkdtemp.call_count <= 3  # May be called multiple times but should be thread-safe
...
class TestAdditionalAudioCoverage:
    ...
    @patch('os.path.isfile')
    @patch('subprocess.run')
    def test_find_ffmpeg_common_locations(self, mock_run: Mock, mock_isfile: Mock) -> None:
    ...
    @patch('subprocess.run')
    @patch('subtitletools.utils.audio.find_ffprobe')
    def test_get_audio_duration_ffprobe_not_found(self, mock_find_ffprobe: Mock, mock_run: Mock) -> None:
    ...
    @patch('subprocess.run')
    @patch('subtitletools.utils.audio.find_ffprobe')
    def test_get_audio_duration_command_failure(self, mock_find_ffprobe: Mock, mock_run: Mock) -> None:
    ...
    @patch('os.path.isfile')
    @patch('subprocess.run')
    def test_find_ffprobe_common_locations(self, mock_run: Mock, mock_isfile: Mock) -> None:
    ...
    @patch('subprocess.run')
    @patch('subtitletools.utils.audio.find_ffprobe')
    def test_validate_audio_file_ffprobe_not_found(self, mock_find_ffprobe: Mock, mock_run: Mock) -> None:
    ...
    def test_extract_audio_small_file_warning(self, mock_stat: Mock, mock_exists: Mock, mock_run: Mock, mock_find_ffmpeg: Mock) -> None:
    ...
    @patch('subtitletools.utils.audio.find_ffmpeg')
    @patch('subprocess.run')
    def test_extract_audio_timeout_exception(self, mock_run: Mock, mock_find_ffmpeg: Mock) -> None:
    ...
    @patch('subtitletools.utils.audio.find_ffmpeg')
    @patch('subprocess.run')
    def test_extract_audio_filenotfound_reraise(self, mock_run: Mock, mock_find_ffmpeg: Mock) -> None:
